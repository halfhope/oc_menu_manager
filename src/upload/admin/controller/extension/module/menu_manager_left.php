...
class ControllerExtensionModuleMenuManagerLeft extends Controller {
	...
	public function menuManagerEventHandler(&$route, &$data, &$code) {
		...
		if (empty($left_menu) || !isset($left_menu['left_menu_data']) || $left_menu['left_menu_data'] == '{}') {
			...
			$this->response->redirect($this->url->link('extension/module/menu_manager_left', 'token=' . $this->session->data['token'], true));
		} else {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/menu_manager_left', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/menu_manager_left', 'token=' . $this->session->data['token'], true);
		$data['reset'] = $this->url->link('extension/module/menu_manager_left' . '/reset', 'token=' . $this->session->data['token'], true);
