		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
					<div class="col-sm-6">
						<?php if (isset($left_menu['left_menu_data'])){ ?>
						<input type="hidden" value="<?php echo htmlspecialchars($left_menu['left_menu_data']) ?>" name="left_menu_data">
						<div class="dd menu_manager" id="left_menu">
							<div class="panel mh35">
								<h3 class="pull-left"><?php echo $text_left_menu ?></h3>
...
$(document).ready(function() {
	...
	$('#left_menu .btn_expand, #preset_menu .btn_expand').on('click', function() {
	...
	$('#left_menu .btn_reset').on('click', function() {
